...
if jieba:
    txtName = basepath + "lishan/class_result_relu_simplemodel.txt"
else:
...
for ep in range(n_epoches):
    ...
    if isval:
        ...
        if ep == n_epoches-1:
            ...
            f = open(basepath + "phase1/validation_simple_class.txt", "w+")
            i = 0
...
if save:
    ...
    f = open(basepath + "phase1/prediction_simple_class.txt", "w+")
    i = 0
    for i in range(sen_result.shape[0]):
